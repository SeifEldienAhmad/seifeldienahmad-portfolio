...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B7nICq3A.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DDcPJbEG.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		...
		meta: [
			...
			{
				name: "description",
				content: "The official personal website of Seif Eldien Ahmad Mohammad. Learn more about his work in cybersecurity, red teaming, and ethical hacking."
			},
			{
				name: "keywords",
				content: "Seif Eldien Ahmad Mohammad, Red Teaming, Cybersecurity, Ethical Hacker, InfoSec"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-4hp4us5W.mjs");
